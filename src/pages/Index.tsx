...
const Index = () => {
  ...
  const features = [
    ...
    },
    {
      ...
      description: "Visualize os aniversariantes do dia e dispare mensagens para todos eles com um único clique.",
    },
    {
      icon: Sparkles,
                ...
                <div className="flex gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Escaneie o QR Code para conectar sua conta WhatsApp de forma segura. Seu número permanece
                      protegido e você mantém total controle.
                    </p>
                  </div>
                </div>
                <div className="flex gap-4">
          ...
          <div className="mb-16">
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <Card className="border-border/50">
                ...
                <CardContent>
                  <p className="text-sm text-muted-foreground">
                    Convide clientes para eventos, webinars, workshops e promoções especiais com mensagens
              ...
              <div className="text-center max-w-3xl mx-auto">
                ...
                <div className="mt-8 pt-6 border-t border-border/50">
                  <p className="text-xs text-muted-foreground/80 leading-relaxed">
                    ...
                    resultar no bloqueio permanente do seu número. Envie mensagens apenas para contatos que autorizaram
                    o recebimento. Recomendamos limitar os envios e respeitar as políticas de uso do WhatsApp para
